...
export class OrderComponent implements OnInit {
  listOrder: Orders[] = []
  displayedColumns: string[] = ['number', 'nameShop', 'description', 'price', 'status', 'action'];
  // columnsToDisplayWithExpand = [...this.displayedColumns, 'expand'];
  // expandedElement: listOrder | null
  ...
  ngOnInit(): void {
    this.displayAllProductDTO()
    this.findAllOrderByCustomer()
  }

  displayAllProductDTO(){
...
// const listOrder: PeriodicElement[] = [
//   {
//     position: 1,
//     name: 'Hydrogen',
//     weight: 1.0079,
